...
class HashTable {
    ...
    private int quadraticProbe(int index, int attempt) {
        int c1 = 1, c2 = 1;
    ...
    public boolean insert(String key, String value) {
        if (count >= size) {
            System.out.println("Hash tablosu dolu!");
            return false;
        }
        ...
        while (attempt < size) {
            ...
            if (table[probeIndex] == null) { // Sadece boş yuva aranır
        ...
        System.out.println("Uygun yuva bulunamadı!");
        return false;
    }
    ...
    public static HashTable readInputFile(String filename) {
        HashTable hashTable = new HashTable(11); // Asal sayı boyutu
