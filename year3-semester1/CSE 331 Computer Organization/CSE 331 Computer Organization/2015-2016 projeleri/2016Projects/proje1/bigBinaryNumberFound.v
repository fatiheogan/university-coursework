module bigBinaryNumberFound(result,number1[4:0],number2[4:0]);
	...
	wire [3:0] tempBetweenBitsAnding,number2Not;
	...
	not
		n7 (number2Not[0],number2[0]),
		n8 (number2Not[1],number2[1]),
		n9 (number2Not[2],number2[2]),
		n10 (number2Not[3],number2[3]);
		
	and 
		n11 (tempBetweenBitsAnding[0],number1[3],number2Not[3]),
		n12 (tempBetweenBitsAnding[1],number1[2],number2Not[2],xorResult[2]),
		n13 (tempBetweenBitsAnding[2],number1[1],number2Not[1],tempFirstBitsAnding[0]),
		n14 (tempBetweenBitsAnding[3],number1[0],number2Not[0],tempFirstBitsAnding[1]);
